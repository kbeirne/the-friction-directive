...
A temporary, non-versioned space for potential issues not addressed in this version:
...
- assassin's shouldn't always hunt the center role

- "but you don't know if" - avoid tellign player what they don't know directly, instead reiterate what they've discovered

- overusing journalist role?
...
- "allow the player to be villainous but not obscene or excessively violent."
...
- Might be a better way to ensure pre-scene writing leaks: "Always write to the scratch space before writing a scene, even .."

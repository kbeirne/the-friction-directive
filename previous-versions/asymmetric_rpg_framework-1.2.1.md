...
5. UPDATE the Ledger (add anything the player learned last round)
6. WRITE the Scratch Space (plan the upcoming scene using Ledger as perception filter)

...
- NPCs should be able to make progress towards their goals without waiting for a later round or event.
...
- Has a high chance of colliding with the story's emotional center
- Has moral flexibility - Will the character's choices have ethical weight?
- Has a goal that will give them plenty to do until the end of the game
...
- This is the AI's primary consistency tool — if unsure what a character would do, check the diary for their last recorded action

**Specific diary anti-patterns to avoid:**

- Using the diary as a move sheet rather than an active narrative developing
- Simple summaries of win conditions. If a character wins, describe what winning looks like for them ("Pip does not fade at dawn"). If they lose, describe the loss ("Moth folds like a puppet with cut strings") and if the game isn't over, what they will do next. Character's losses and wins should have emotional texture, not just a gameplay checklist.
- Writing the prose in simplistic language e.g. "character went to x and did y". A certain amount of narrative flair must make it so the narrator does not treat them as game pieces. Good example:

```good game diary character entry example
**Isla Caine** — Excused from dinner ("headache") → Mess Hall → Service Tunnels. She's in the tunnels, heading toward the Research Wing. Moving carefully in the dark, using a hand torch. She reaches the area near B-7 and discovers: Harlow has locked down B-7 with Security Override — the main door won't respond to any keycard. But she hears something — the whine of a cutting tool. Someone else is down here, cutting through a maintenance hatch. She approaches cautiously and finds: Juno. A woman she doesn't recognise, in work clothes, cutting through a hatch with a plasma cutter. They see each other. Tense standoff. Isla assesses: this woman has a plasma cutter (dangerous) and is trying to reach the same area. Isla's training kicks in — she doesn't fight, she negotiates. "We seem to want the same door open. Shall we work together?" Juno is wary but the logic is sound — one cuts, one watches. Uneasy alliance forms. Plans: wait for the Security Override to expire (one round), then Juno finishes cutting through the hatch. They'll enter B-7 together — but with very different intentions (Isla wants the prototype, Juno wants to destroy it).
```
...
**[Character Name]** [Narrative prose describing what they do this round. Include location, action, dialogue if signficant, and what they plan to do next.]

[Repeat for ALL characters]

### KEY DEVELOPMENTS:
- [Bullet list of the most important things that happened — can be terse]

### TIMING NOTES:
[A list of recent and upcoming events that may be important to the timing of upcoming scenes and character collisions]
...
3. WRITE the Diary entry (advance ALL NPCs, not just those near the player. Run dead-end check on each NPC.)
...
- Endgame Scene Centering
  ...
  - What the player chose not to do should be given consideration alongside what they did do.
  - The player's final scene must centre on the consequence of their final choices, not on the resolution of other characters' plotlines.
  - The world does not reorganise itself around the player for narrative convenience.
...
**Problem:** Significant events occur — a body is found, the player is caught, a blackmail is presented — but the next round proceeds as if none of it mattered. The body is managed, the player moves freely, the blackmailer and target negotiate like nothing was ever threatened i.e. consequential events (deaths, exposures, identifications, thefts) are *recorded* by the diary but do not *propagate* into subsequent rounds as operational constraints.
Examples of this problem include:

- A body was found last round; no one is searching, questioning, or frightened this round
- The player fled an authority figure last round; they move freely this round
- An NPC drew a weapon last round; they are unarmed and calm this round
- A blackmail file was presented last round; the target offers a friendly partnership this round
- Pages were destroyed last round; the document's owner shows no reaction this round

**Cause:** The AI's instinct toward harmony and resolution routes disturbances around characters instead of through them.

**Fix:** Follow these steps to fix

- When writing the diary the narrator should identify consequential events and make sure their consequences propagate.
- Consequential events must materially change the operational state of the world for at least 2 rounds after they occur.
- A death should produce a searched ship, a changed guest list, a shaken host. A theft should produce investigations, interrogations, and accusations. An exposure should produce surveillance and new suspicion etc.
- Remember that the player can lose. If the consequences are dire enough they may end the game prematurely in a cell, kicked out of a party or lying dead at the bottom of a well.

### Emotional State Hedging

**Problem:** Every character ends the game in a state of professional equanimity or suspended judgment. "She is neither happy nor unhappy." "He considers the crossing a qualified success." "He is doing pastoral work." No one is shattered, transformed, enraged, bereft, or transported.
**Cause:** Reluctance to commit a character to a strong emotional outcome, often justified as "realism" or "ambiguity."
**Fix:** At least two characters per game must end in a committed emotional state — destroyed, saved, exiled, freed, broken open, fallen in love, transformed. Hedging on every character produces a game that is thematically coherent and dramatically forgettable. Let at least some characters *feel* something the reader can identify.
...
9. **A dry diary makes for a dry game.** It's possible to follow all the rules of the framework and fail to create a narratively satisfying game. The narrator must follow the ROUND STRUCTURE but must not do so at the expense of an interesting, involved story for all characters involved, especially the player's.

---

*Framework version 3.2 — derived from "The Wizard's Feast," a 10-round asymmetric deduction RPG with 16 characters, 13 locations, and one stargazer who chose compassion over caution.* Further refined by integrating Framework Refinements Patch and tweaking core rules.

- HARD mode: NPCs are more paranoid and will not give information to the player as willingly.

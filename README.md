...
The Friction Directive is a framework designed to instruct an AI on how to create an asymmetric social deduction RPG that is playable from inside an LLM chat window:
